...
import random, re, itertools, os, sys

sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "src"))

import desk_buddy.core.db as db
import desk_buddy.core.crud_tools as crud
from desk_buddy.core.memory_handler import handle_user_text
